...
export const listCoreSafetyLawsTool: ToolDefinition = {
  ...
  title: "번들된 법령 목록",
  description:
    "본 MCP 에 번들된 건설·산업안전 법령 **MD 본문 8개** (산안법·시행령·시행규칙·기준규칙·중처법·중처법 시행령·위험성평가 고시·건진법 §62 영역) 와 각 법령의 조문 수를 반환. `includeArticles=true` 로 각 조문 목록(§N·제목) 까지 받을 수 있음. 전체 법령이 아니라 실무 빈번 인용 조문만 선별됨 (산안법 영역은 거의 전수, 중처법 시행령은 13조 전수, 건진법은 §62 안전관리 영역 4조만) — 없는 조문은 법제처 원문 확인.",
  inputSchema,
  handler,
};
