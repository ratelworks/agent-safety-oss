...
| 버전 | 보안 패치 지원 | 비고 |
|---|:--:|---|
| 1.3.x | ✅ | 현재 안정판 (v1.3.0 — 첫 PUBLIC release) |

> 차기 minor (1.4.x) release 시 1.3.x 의 critical-only 지원 기간(3개월)이 본 표에 추가됩니다.
...
**v1.3.0 정합** — 본 OSS 는 데이터 영속 위치만 제공하며, 다음은 **사용자(안전관리자·현장 관리자)의 책임 영역**입니다:
