...
| 버전 | 보안 패치 지원 | 비고 |
|---|:--:|---|
| 1.6.x | ✅ | 현재 안정판 (v<!-- INV:VERSION -->1.6.1<!-- /INV:VERSION -->) |
| 1.5.x | ⚠️ | 이전 안정판 (v1.5.0) — critical-only 패치 (2026-08-30 까지 3개월) |
...
**v<!-- INV:VERSION -->1.6.1<!-- /INV:VERSION --> 정합** — 본 OSS 는 데이터 영속 위치만 제공하며, 다음은 **사용자(안전관리자·현장 관리자)의 책임 영역**입니다:
