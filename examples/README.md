...
| [`mcp-list-tools.sh`](./mcp-list-tools.sh) | 등록된 MCP 도구 카탈로그 출력 (현재 수: `docs/INVENTORY.md` 참조 — 자동 산출) |
...
`get_kosha_guide_md` 외 <!-- INV:TOOLS_KEYREQ -->7<!-- /INV:TOOLS_KEYREQ -->개 Live 도구는 다음 두 경로 중 하나로 호출합니다.
